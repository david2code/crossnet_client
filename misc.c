 ...
 *
 */
int create_socket_to_server_on_eth(uint32_t bind_ip, uint16_t bind_port, uint32_t ip, uint16_t port, int connect_timeout, int *fd)
{    
...
int create_socket_to_server(uint32_t ip, uint16_t port, int connect_timeout, int *fd)
{
